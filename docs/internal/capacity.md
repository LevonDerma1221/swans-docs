...
**Working assumptions [confirm with Lyes and Levon]:** year one, 40 trading members, 8 clearing members, 12 liquidity providers, 300 live contracts, 250,000 order messages per day, peak 3,000 messages per second (quote updates around macro releases), 5,000 trades per day, 2,000 accounts. Year three, 5× each.
...
## STP
Trade matched to CCP submission (p99) 500 ms; CCP round trip within the RTS 26 window **[confirm]**.
