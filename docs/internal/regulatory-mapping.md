...
| Clearing member limits and STP timings | RTS 26; UK EMIR | Clearer API, trades service |
...
| CCP margin floors (OTC-classified) | UK EMIR RTS 153 (99.5% / 5 days; offsets on demonstrated correlation) | CCP parameter file, offset triggers |
